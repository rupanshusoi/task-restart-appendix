...
void StencilMapper::select_sharding_functor(const Mapping::MapperContext ctx,
                               const Task&                        task,
                               const SelectShardingFunctorInput&  input,
                                     SelectShardingFunctorOutput& output) {
...
void StencilMapper::replicate_task(MapperContext ctx, const Task &task, const ReplicateTaskInput &input, ReplicateTaskOutput &output)
{
...
void StencilMapper::select_task_options(MapperContext ctx, const Task &task, TaskOptions &output)
{
